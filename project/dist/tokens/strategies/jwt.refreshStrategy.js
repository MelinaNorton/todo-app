...
var RefreshCookieExtractor = function (req) {
    var _a;
    if (!(req === null || req === void 0 ? void 0 : req.cookies)) {
        console.error("No Request recieved from CookieExtractor");
        return null;
    }
    return (_a = req.cookies['refreshtoken']) !== null && _a !== void 0 ? _a : null;
};
var JwtRefreshStrategy = (function (_super) {
    __extends(JwtRefreshStrategy, _super);
    function JwtRefreshStrategy(config, tokensService) {
        var _this = _super.call(this, {
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([RefreshCookieExtractor]),
            ignoreExpiration: false,
            secretOrKey: config.get('JWT_REFRESH_SECRET')
        }) || this;
        _this.tokensService = tokensService;
        return _this;
    }
    JwtRefreshStrategy.prototype.validate = function (payload) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.tokensService.findOne(payload.jti)];
                    case 1:
                        found = _a.sent();
                        if (!found) {
                            throw new common_1.UnauthorizedException("Refresh Token Missing or Revoked");
                        }
                        return [2, { jti: payload.jti, sub: payload.sub, username: payload.username }];
                }
            });
        });
    };

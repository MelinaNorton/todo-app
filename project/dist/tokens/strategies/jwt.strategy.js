...
var CookieExtractor = function (req) {
    ...
    return (_a = req.cookies['token']) !== null && _a !== void 0 ? _a : null;
};
var LoggingExtractor = function (req) {
    console.log('→ RAW auth header:', req.headers.authorization);
    return passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken()(req);
};
var JwtStrategy = (function (_super) {
    __extends(JwtStrategy, _super);
    function JwtStrategy(config, tokensService) {

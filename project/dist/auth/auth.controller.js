...
var AuthController = (function () {
    function AuthController(authService, tokensService) {
        this.authService = authService;
        this.tokensService = tokensService;
    }
    AuthController.prototype.signup = function (createAuthDto) {
        return this.authService.signup(createAuthDto);
    };
    AuthController.prototype.login = function (loginAuthDto, res, req) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.authService.login(loginAuthDto, res, req)];
                    case 1:
                        tokens = _a.sent();
                        console.log("Tokens returned to login controller: ", tokens);
                        return [2, tokens.accesstoken];
                }
            });
        });
    };
